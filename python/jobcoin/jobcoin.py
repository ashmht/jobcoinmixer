...
class JobCoin:
    def __init__(self, deposit_addresses, customer_address_map, big_house_address):
        self.deposit_addresses: Dict[int, str] = deposit_addresses
        self.customer_address_map: Dict[int, List[str]] = customer_address_map
        self.big_house_address: str = big_house_address
